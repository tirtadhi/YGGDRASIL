...
$query = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_buku, buku.judul, peminjaman.nim, member.nama, peminjaman.id_admin, peminjaman.tgl_peminjaman, peminjaman.tgl_pengembalian
FROM peminjaman
...
<html lang="en">
  ...
  <div class="d-flex flex-wrap gap-3">
    <div class="mb-3">
      ...
      <input type="number" class="form-control" placeholder="nim Siswa" name="nim" id="nim" value="<?= $item["nim"]; ?>" readonly>
    </div>
    <div class="mb-3">
